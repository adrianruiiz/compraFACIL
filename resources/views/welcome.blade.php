                ...
                <div class="mt-6">
                    <button class="bg-white text-blue-400 shadow-lg font-normal h-10 w-10 items-center justify-center align-center rounded-full outline-none focus:outline-none mr-2 p-3" type="button">
                        ...
                        <button class="bg-white text-pink-400 shadow-lg font-normal h-10 w-10 items-center justify-center align-center rounded-full outline-none focus:outline-none mr-2 p-3" type="button">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 400 400" id="roblox"><path fill="#e51f04" d="M82.4 0 0 317.6 317.6 400 400 82.4 82.4 0zm94.9 161.4 61.3 15.9-15.9 61.3-61.3-15.9 15.9-61.3z"></path></svg>                    </button>
                            ...
                            <div class="flex flex-wrap items-top mb-6">
                                <div class="w-full lg:w-4/12 px-4 ml-auto">
                                    ...
                                    <ul class="list-unstyled">
                                        ...
                                        <li>
                                            <a class="text-gray-700 hover:text-gray-900 font-semibold block pb-2 text-sm" href="#services">
                                                Servicios
                                            </a>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <a class="text-gray-700 hover:text-gray-900 font-semibold block pb-2 text-sm" href="#faq">
                                ...
                                <div class="w-full lg:w-4/12 px-4">
                                    ...
                                    <ul class="list-unstyled">
                                        ...
                                        <li>
                                            <a class="text-gray-700 hover:text-gray-900 font-semibold block pb-2 text-sm" href="#support">
                                                Soporte
                                            </a>
                                        </li>
                                        <li>
                                            <a class="text-gray-700 hover:text-gray-900 font-semibold block pb-2 text-sm" href="#blog">
                                                Blog
                                            </a>
                                        </li>
                                    </ul>
